...
from payment.payment_methods import PAYMENT_PROCESSORS
...
def handle_payment(total: Decimal) -> None:
    payment_type = input("What payment method would you like to use? (cc/paypal/apple) ")

    if payment_type in PAYMENT_PROCESSORS:
        payment_processor = PAYMENT_PROCESSORS[payment_type]
